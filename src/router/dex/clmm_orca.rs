//! Orca Whirlpool multi-tick crossing quoting math.
//!
//! Walks initialized ticks with liquidity adjustment at each boundary.
...
/// Quote an Orca Whirlpool swap with optional multi-tick crossing.
///
...
/// Multi-tick CLMM swap simulation for Orca Whirlpool.
